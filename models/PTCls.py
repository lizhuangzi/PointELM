from models.pointnet_util2 import index_points, square_distance
import torch
...
import torch
import torch.nn as nn
from models.pointnet_util2 import PointNetFeaturePropagation, PointNetSetAbstraction
...
class PointTransformerCls(nn.Module):
    ...
    def forward(self, x):
        ...
        res = self.fc2(points)
        return res,gbf,points


if __name__ == '__main__':
    data = torch.rand(2,1024,3).cuda()
    print("===> testing PointTransformerCls ...")
    model = PointTransformerCls(num_class=40).cuda()
    out = model(data)
    print(out.shape)
